...
const ACTION_LABELS: Record<string, string> = {
  ...
  'attendance.registered_by_qr': 'Registró su llegada mediante QR',
  'attendance.qr_created': 'Generó el QR de asistencia de una sucursal',
  'attendance.qr_regenerated': 'Reemplazó el QR de asistencia de una sucursal',
  'attendance.qr_revoked': 'Revocó el QR de asistencia de una sucursal',
